...
from .views import get_carriage_list, get_carriage, put_carriage, post_carriage, delete_carriage, get_route_list, \
    ...
    get_train_route_with_squad_on_date, post_train_route_with_squad_on_date, \
    put_train_route_with_squad_on_date, delete_train_route_with_squad_on_date, get_railway_branch_list, \
...
urlpatterns = [
    ...
    path('train_route_with_squad_on_date/<int:ID>/', get_train_route_with_squad_on_date, name='get_train_route_with_squad_on_date'),
    path('train_route_with_squad_on_date/post/', post_train_route_with_squad_on_date, name='post_train_route_with_squad_on_date'),
    path('train_route_with_squad_on_date/<int:ID>/put', put_train_route_with_squad_on_date, name='put_train_route_with_squad_on_date'),
    path('train_route_with_squad_on_date/<int:ID>/delete', delete_train_route_with_squad_on_date, name='delete_train_on_station_on_date'),
